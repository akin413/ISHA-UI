...
function initializeTheme() {
  // Check if the browser currently prefers dark scheme
  const isDark = window.matchMedia("(prefers-color-scheme: dark)").matches;

  // Set the data-theme attribute on the HTML element
  // Although the CSS @media query handles the heavy lifting,
  // setting this attribute is good practice for future overrides.
